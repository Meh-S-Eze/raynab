...
function displayError(error, title) {
    ...
    if (apiError.id === '400') {
        ...
        return { title: title !== null && title !== void 0 ? title : 'Bad request', message: `Malformed request to the API: ${apiError.detail}` };
    }
    const errorMessage = ErrorTable.get(apiError.id);
    return { title: title !== null && title !== void 0 ? title : apiError.name, message: errorMessage !== null && errorMessage !== void 0 ? errorMessage : apiError.detail };
}
